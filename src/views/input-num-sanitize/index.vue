...
const onChange_1 = (e: InputEvent)=>{
  ...
  value_1.value = numSanitize(target.value, false, false, true)
}
...
const onChange_2 = (e: InputEvent)=>{
  const target = e.target as HTMLInputElement
  value_2.value = numSanitize(target.value, false, false)
}
...
const onChange_3 = (e: InputEvent)=>{
  const target = e.target as HTMLInputElement
  value_3.value = numSanitize(target.value, false)
}
...
const onChange_4 = (e: InputEvent)=>{
  const target = e.target as HTMLInputElement
  value_4.value = numSanitize(target.value, true, false)
}
...
const onChange_5 = (e: InputEvent)=>{
  const target = e.target as HTMLInputElement
  value_5.value = numSanitize(target.value)
}
